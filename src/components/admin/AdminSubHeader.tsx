...
export default function AdminSubHeader({
  ...
  return <div className="bg-hero-gradient px-5 pt-5 pb-4 flex-shrink-0">
      <div className="flex items-center gap-3">
        ...
        <div>
          <p className="text-primary-foreground/60 text-[10px] font-medium uppercase tracking-wide">administrator control center
