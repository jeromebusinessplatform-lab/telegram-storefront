...
create index if not exists telegram_message_routes_message_id_idx on telegram_message_routes(telegram_message_id);
create index if not exists telegram_message_routes_thread_id_idx on telegram_message_routes(thread_id);
